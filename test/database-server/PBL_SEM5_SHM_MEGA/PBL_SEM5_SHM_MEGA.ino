...
void loop() {
  ...
  Serial.print("Acc X: "); Serial.print(accelX, 1);
  Serial.print(" Y: "); Serial.print(accelY, 1);
  Serial.print(" Z: "); Serial.println(accelZ, 1);
  ...
  Serial1.print("Temp: "); Serial1.print(temperature);
  Serial1.print(" C, Humidity: "); Serial1.println(humidity);
  Serial1.print("Acc X: "); Serial1.print(accelX, 1);
  Serial1.print(" Y: "); Serial1.print(accelY, 1);
  Serial1.print(" Z: "); Serial1.println(accelZ, 1);
  Serial1.print("Gyro X: "); Serial1.print(gyroX, 1);
  Serial1.print(" Y: "); Serial1.print(gyroY, 1);
  Serial1.print(" Z: "); Serial1.println(gyroZ, 1);

  // Tampilkan di OLED
  display.clearDisplay();
  display.setCursor(0, 0);
  display.println("Acc (m/s^2)");
  display.print(accelX, 1); display.print(",");
  display.print(accelY, 1); display.print(",");
  display.print(accelZ, 1); display.println("");
  display.println("Gyro (rps)");
  display.print(gyroX, 1); display.print(",");
  display.print(gyroY, 1); display.print(",");
  display.print(gyroZ, 1); display.println("");
  display.print("Temp: "); display.print(temperature);
  display.print(" C  Humidity: "); display.println(humidity);
  display.display();

  // Tampilkan di LCD
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("G X:"); lcd.print(gyroX, 1);
  lcd.setCursor(8, 0);
  lcd.print("Y:"); lcd.print(gyroY, 1);
  lcd.setCursor(0, 1);
